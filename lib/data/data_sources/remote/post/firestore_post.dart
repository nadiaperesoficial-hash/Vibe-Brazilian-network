    ...
    for (int i = 0; i < condition; i++) {
      try {
        ...
        if (snap.exists) {
          ...
          // Aceita post de texto puro (postUrl vazio mas caption não vazio)
          bool isTextPost = postReformat.postUrl.isEmpty &&
              postReformat.caption.isNotEmpty;
          bool isMediaPost = postReformat.postUrl.isNotEmpty;
          if (isTextPost || isMediaPost) {
