...
import 'package:vibe/core/utility/feed_notifier.dart';
...
class CustomAppBar {
  ...
  static void showCreatePost(BuildContext context) {
            ...
            child: Column(
              ...
              children: [
                ...
                _postOption(
                  ...
                  onTap: () {
                    Navigator.pop(ctx);
                    _openTextPost(context, postCubit);
                  },
                ),
                ...
                _postOption(
                  ...
                  onTap: () {
                    Navigator.pop(ctx);
                    _openLinkPost(context, postCubit);
                  },
                ),
  ...
  static void _openTextPost(BuildContext context, PostCubit postCubit) {
                      ...
                      onPressed: isPosting
                          ...
                          : () async {
                              ...
                              try {
                                ...
                                await postCubit.createPost(post, []);
                                FeedNotifier.triggerReload();
  ...
  static void _openLinkPost(BuildContext context, PostCubit postCubit) {
