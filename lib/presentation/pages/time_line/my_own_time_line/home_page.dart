...
import 'package:instagram/core/utility/feed_notifier.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void _onFeedReload() {
    if (mounted) _getData(0);
  }

  @override
  void initState() {
    _getData(0);
    FeedNotifier.reload.addListener(_onFeedReload);
    if (isThatMobile) {
  ...
  @override
  void dispose() {
    FeedNotifier.reload.removeListener(_onFeedReload);
